...
class CreateFile():
    ...
    def createfile(self):
        ...
        # PARENT_DIR = "C:/Users/pltguest/Downloads/Sujet TP et fichiers-20260305/Codes dacquisition/{}/".format(date)   # Get the path. #!!!!CHANGE DIRECTORY!!!!#
        PARENT_DIR = "C:/Users/pltguest/Downloads/CACA/{}/".format(date)   # Get the path. #!!!!CHANGE DIRECTORY!!!!#
...
class IV_Characteristic(mp.Process):
    ...
    def init_keithley(self):
        ...
        ipaddr_2 = "TCPIP0::134.157.105.91::inst0::INSTR" #SMU2 (Drain)
